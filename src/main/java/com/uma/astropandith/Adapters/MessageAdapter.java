...
//
        ...
        if(attatch_image!=null)
           ...
           // Picasso.get().load("https://meraastro.com/admin/"+attatch_image).into(holder.attachImage);
            Picasso.get().load("https://meraastro.in/admin/"+attatch_image).into(holder.attachImage);
