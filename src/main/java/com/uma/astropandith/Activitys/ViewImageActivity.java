...
public class ViewImageActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView attach_imageView;
    private String attatch_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            attatch_image = extras.getString("attatch_image");
        ...
        Picasso.get().load(attatch_image).into(attach_imageView);

       // attach_imageView.setOnTouchListener(this);
